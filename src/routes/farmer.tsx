...
const healthData = [
  { day: "Day 1", ndvi: 0.45 },
  { day: "Day 15", ndvi: 0.52 },
  { day: "Day 30", ndvi: 0.65 },
  { day: "Day 45", ndvi: 0.78 },
  { day: "Day 60", ndvi: 0.87 },
];
...
export const Route = createFileRoute("/farmer")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Track your crop loans, NDVI health score, and repayment schedule on AgriFi.",
      },
    ],
  }),
});
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-10">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold">Your active crop loans</h2>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-4">
                      <div className="flex justify-between text-xs mb-1.5">
                        ...
                        <span
                          className={
                            loan.health > 75 ? "text-success font-medium" : "text-gold font-medium"
                          }
                        >
                          {loan.health}%
                        </span>
          ...
          <div className="space-y-4">
            <Card className="p-5">
              ...
              <p className="text-xs text-muted-foreground">
                Current NDVI health score of <strong>0.87</strong> indicates optimal crop
                development. Next satellite pass: Tomorrow, 10:30 AM.
              </p>
            </Card>
            ...
            <Card className="p-5 border-gold/30 bg-gold/5">
              <div className="flex gap-3">
                ...
                <div className="text-sm">
                  <p className="font-medium mb-1">Insurance active</p>
                  <p className="text-xs text-muted-foreground">
                    Both loans are protected by parametric insurance. No climate risks detected for
                    your region.
                  </p>
                </div>
              </div>
